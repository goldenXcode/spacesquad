...
*   class Separation
*
*   Implements the Alignment behaviour
*/
public class Alignment extends Behavior
{
	...
	*/
	public Alignment(int nearAreaRadius, int influence)
	{  
		m_neighborhood = new Neighborhood();
		m_nearVehicles = new Vector();
	...
	*/
	...
	public Vector2d calculate(Vehicle v)
	{
		...
		{			
			...
			vel_sum=vel_sum.add(neighbor_vehicle.getVel());
			
		}
		
		if (count!=0) vel_sum.scale(1/count);
		
		vel_sum.scale(m_influence);
